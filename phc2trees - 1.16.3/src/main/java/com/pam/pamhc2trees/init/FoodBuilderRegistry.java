...
public class FoodBuilderRegistry {
	...
	public static final Food CHERRYITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food ORANGEITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food PEACHITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food PEARITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	...
	public static final Food DATEITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food DRAGONFRUITITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food FIGITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food GRAPEFRUITITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food JACKFRUITITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food MANGOITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food OLIVEITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food PAPAYAITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food PERSIMMONITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food POMEGRANATEITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food STARFRUITITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food BREADFRUITITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food GUAVAITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	public static final Food LYCHEEITEM = (new Food.Builder()).hunger(4).saturation(0.3F).build();
	...
	//Not Tasty Fruits
	public static final Food CANDLENUTITEM  = (new Food.Builder()).hunger(1).saturation(0.1F).build();
	public static final Food DURIANITEM  = (new Food.Builder()).hunger(1).saturation(0.1F).build();
